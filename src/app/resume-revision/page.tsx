    ...
    <div style={{ background: colors.pageBg, color: colors.text }}>
      ...
      <section style={{ ...section, background: '#e3e3e3' }}>
        <div style={{ ...maxw, display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 24, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: 12, letterSpacing: '0.18em', fontWeight: 800, color: '#666' }}>RESUME WRITING & REVISION SERVICES</div>
            <h1 style={{ margin: '8px 0 0 0', fontSize: 40, lineHeight: 1.1, fontWeight: 900 }}>Résumé Revision</h1>
            <h3 style={{ margin: '6px 0 0 0', fontSize: 22, fontWeight: 800 }}>The résumé to land your dream job.</h3>
            <p style={{ marginTop: 10, color: '#555', fontSize: 18 }}>We’ve helped thousands of job seekers secure interviews and offers by transforming their résumés. Let our human‑led specialists turn your résumé into a compelling narrative.</p>
          ...
          <div>
            <div style={{ background: `linear-gradient(135deg, ${colors.white}, #f7f7f7)`, border: `1px solid ${colors.line}`, borderRadius: 12, height: 320, boxShadow: '0 10px 30px rgba(0,0,0,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
              <div style={{ color: '#8a8a8a' }}>Professional with polished résumé (image)</div>
        ...
        <div style={maxw}>
          ...
          <div style={{ marginTop: 18 }}>
            <div style={{ background: '#fafafa', border: `1px solid ${colors.line}`, borderRadius: 12, padding: 18 }}>
              ...
              <div style={{ fontWeight: 800, fontSize: 18 }}>Résumé Revision</div>
              <p style={{ color: '#666', marginTop: 6 }}>We know exactly what companies look for in a résumé. Let’s make yours a perfect fit. Impress all the hiring managers. Stand out with our résumé format. Build your perfect résumé.</p>
              ...
              <div style={{ marginTop: 10, color: '#777', fontSize: 12 }}>*Pay in 4 installments over 2 months (prices in USD). Payment plan availability varies by country. This is a one-time purchase, not a subscription.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={section}>
        <div style={maxw}>
          ...
          <p style={{ marginTop: 6, color: '#555' }}>Our hiring managers, recruiters, and industry professionals write you the perfect résumé with our most popular service.</p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18, marginTop: 18 }}>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              {[
                ['Send us your résumé', 'Tell us about your career goals, experience, and skills.'],
                ['We contact you (1–2 days)', 'We email you to understand your target roles.'],
                ['We fix your résumé (2–3 days)', 'We rewrite and optimize to highlight your strengths.'],
                ['Feedback session (2 days)', 'Discuss your revised résumé live with a specialist.'],
                ['Your résumé is complete! (2 days)', 'Final revisions and delivery. Get ready to impress.']
              ].map(([t, d], i) => (
              ...
              <div style={{ marginTop: 6 }}>
                <a href="/signup" style={cta}>Perfect your résumé now</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ ...section, background: colors.white }}>
        <div style={maxw}>
          <h2 style={{ margin: 0, fontSize: 28, fontWeight: 900 }}>Why revise your résumé?</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16, marginTop: 16 }}>
            {[
              ['Get noticed', 'Our team remakes your résumé to catch recruiters’ eyes.'],
              ['Get interviews', 'Most clients secure interviews within 4–8 weeks.'],
              ['Land a job', 'Most clients land roles within 3 months.']
            ].map(([t, d]) => (
      ...
      <section style={{ ...section, paddingTop: 32, paddingBottom: 32 }}>
        <div style={{ ...maxw, background: '#e0f2ed', border: `1px solid ${colors.line}`, borderRadius: 12, padding: 22, textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 6, color: '#555' }}>Perfect your résumé and get interview‑ready with our specialists.</div>
