...
export default function JobSearchHubInterviewPage() {
  const [searchQuery, setSearchQuery] = useState('');
  const [email, setEmail] = useState('');

  const interviewPosts = [
    {
      title: 'Learn to Interview with Confidence and Land the Job You Deserve',
      excerpt: 'Master the art of interviewing with proven techniques that help you showcase your skills, answer tough questions, and leave a lasting impression on hiring managers.',
    ...
    {
      title: 'How to Answer Short-Answer Interview Questions: The STAR Method',
      excerpt: 'Learn the STAR method (Situation, Task, Action, Result) to structure compelling answers that demonstrate your value and problem-solving abilities.',
    ...
    },
    {
      ...
      excerpt: 'Prepare for any interview with our comprehensive guide to the most common questions. Includes example answers and tips for tailoring responses to your experience.',
      date: 'August 25, 2025',
    ...
    {
      title: 'Virtual Interview Success: How to Ace Remote Interviews',
      excerpt: 'Virtual interviews require special preparation. Learn how to optimize your setup, manage technical issues, and build rapport through a screen.',
      date: 'July 22, 2025',
      readTime: '9 min read',
      badge: null,
      link: '#'
    ...
    {
      title: 'Behavioral Interview Questions: What Employers Really Want to Know',
      excerpt: 'Behavioral questions reveal how you handle real-world situations. Discover what employers are looking for and how to craft stories that showcase your strengths.',
      date: 'June 30, 2025',
    ...
    <div style={{ backgroundColor: '#ebebeb', minHeight: '100vh' }}>
      ...
      <section style={{ 
        ...
        <h1 style={{ 
          ...
          Learn to Interview with Confidence and Land the Job You Deserve
        </h1>
        ...
        <p style={{
          ...
          Master interview techniques, answer tough questions with confidence, and turn every interview into a job offer with expert preparation strategies.
        </p>
        ...
        <div style={{
          ...
          <span style={{ color: '#2e2e2e', fontWeight: 600 }}>Interview</span>
        </div>
      </section>
      ...
      <section style={{
              ...
              {[
                ...
                <a
                  ...
                  style={{
                    ...
                    fontSize: '15px',
                    fontWeight: 600,
                    color: item.id === 'step6' ? '#fff' : '#2e2e2e',
                    backgroundColor: item.id === 'step6' ? '#16a085' : 'transparent',
                    border: 'none',
                    borderRadius: '8px',
                    textAlign: 'left',
                    textDecoration: 'none',
        ...
        <div style={{ flex: '1 1 800px' }}>
          ...
          {/* Cross-sell to Interview Prep Service and Template */}
          <div style={{
            marginTop: '48px',
            backgroundColor: '#fff',
            borderRadius: '12px',
            ...
            <p style={{
              ...
              Our Interview Prep service provides personalized coaching to help you answer questions confidently, showcase your value, and convert interviews into offers. Download our free template to get started, or work with an expert coach.
            </p>
            <div style={{
              display: 'flex',
              gap: '16px',
