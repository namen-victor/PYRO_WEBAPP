...
export default function JobSearchHubApplyingPage() {
  const [searchQuery, setSearchQuery] = useState('');
  const [email, setEmail] = useState('');

  const applyingPosts = [
    {
      title: 'The KisMma Nhuhts Experiment: Applying to 100 Jobs with a Creative Name',
      excerpt: 'A quirky alias got 29% interview rate in 100 apps but results came from strong, metrics-driven bullets and clear titles, not the name itself.',
      date: 'August 7, 2025',
      readTime: '5 min read',
      badge: 'Most Popular',
      link: '#'
    ...
    {
      title: 'How to Land Your Dream Job Without Actively Applying',
      excerpt: 'Happiness streaked through me like a comet. I wanted to shout for joy as I could not believe the message I just received. For a moment, I felt like I was reading the message.',
      date: 'May 12, 2024',
    ...
    <div style={{ backgroundColor: '#ebebeb', minHeight: '100vh' }}>
      ...
      <section style={{ 
        ...
        <div style={{
          ...
          JOB SEARCH HUB: APPLYING TO JOBS
        </div>
        ...
        <h1 style={{ 
          ...
          Master the Job Application Process from Start to Submit
        </h1>
        ...
        <p style={{
          ...
          Learn how to optimize each step of the application process—from selecting the right roles to submitting a polished application—so you can maximize your interview chances.
        </p>
        ...
        <div style={{
          ...
          <span style={{ color: '#2e2e2e', fontWeight: 600 }}>Applying to Jobs</span>
        </div>
      </section>
      ...
      <section style={{
              ...
              {[
                ...
                <a
                  ...
                  style={{
                    ...
                    fontSize: '15px',
                    fontWeight: 600,
                    color: item.id === 'step4' ? '#fff' : '#2e2e2e',
                    backgroundColor: item.id === 'step4' ? '#16a085' : 'transparent',
                    border: 'none',
                    borderRadius: '8px',
                    textAlign: 'left',
                    textDecoration: 'none',
        ...
        <div style={{ flex: '1 1 800px' }}>
          ...
          {/* Cross-sell to Full-Service Apply */}
          <div style={{
            marginTop: '48px',
            backgroundColor: '#fff',
            borderRadius: '12px',
            ...
            <h3 style={{
              ...
              Want us to handle applications for you?
            </h3>
            <p style={{
              fontSize: '16px',
              color: '#555',
              ...
              Save time and maximize your chances with our Full-Service Apply to Jobs. Our specialists submit tailored applications on your behalf, track progress, and keep you updated every step of the way.
            </p>
            <div style={{
              display: 'flex',
              gap: '16px',
              ...
              >
                Learn More About Full-Service Apply
              </a>
              <a
                href="/guarantee"
                style={{
      ...
      <footer style={{ 
        ...
        <div style={{ 
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Online Course</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>PyroAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>ResumeAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>JobBoardAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>NetworkAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>InterviewAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>CoverLetterAI</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>JobTrackerAI</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li style={{ marginBottom: '10px' }}><a href="/bundles" style={{ color: '#ccc', textDecoration: 'none' }}>Services Bundles</a></li>
              <li style={{ marginBottom: '10px' }}><a href="/career-consulting" style={{ color: '#ccc', textDecoration: 'none' }}>Career Consulting</a></li>
              <li style={{ marginBottom: '10px' }}><a href="/resume-revision" style={{ color: '#ccc', textDecoration: 'none' }}>Resume Revision</a></li>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Success Stories</a></li>
              ...
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Underfunded</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Higher Education</a></li>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Brand Ambassadors</a></li>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>FAQ</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ marginBottom: '10px' }}><a href="#" style={{ color: '#ccc', textDecoration: 'none' }}>Contact Us</a></li>
              <li style={{ marginBottom: '10px', color: '#ccc' }}>📧 hello@pyrosolutions.com</li>
            </ul>
            <div style={{ marginTop: '20px' }}>
              <p style={{ fontSize: '14px', fontWeight: 600, marginBottom: '12px', color: '#fff' }}>Follow Us:</p>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <a href="#" style={{ fontSize: '14px', color: '#999', textDecoration: 'none' }}>Terms & Conditions</a>
            <a href="#" style={{ fontSize: '14px', color: '#999', textDecoration: 'none' }}>Consent Preferences</a>
          </div>
        </div>
      </footer>
    </div>
