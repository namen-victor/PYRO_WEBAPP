...
export default function JobSearchHubCoverLetterPage() {
  const [searchQuery, setSearchQuery] = useState('');
  const [email, setEmail] = useState('');

  const coverLetterPosts = [
    {
      title: 'Crafting the Perfect Cover Letter: How CoverLetterAI Can Help',
      excerpt: 'Improve your chances of getting hired with a standout cover letter. Learn how to tailor your skills, highlight relevant experience, and avoid common mistakes.',
    ...
    <div style={{ backgroundColor: '#ebebeb', minHeight: '100vh' }}>
      ...
      <section style={{ 
        ...
        <h1 style={{ 
          ...
          Craft Cover Letters That Get Noticed and Get Interviews
        </h1>
        ...
        <p style={{
          ...
          Learn how to tailor your cover letters to the role, highlight your most relevant experiences, and avoid common mistakes.
        </p>
        ...
        <div style={{
          ...
          <span style={{ color: '#2e2e2e', fontWeight: 600 }}>Cover Letter</span>
        </div>
      </section>
      ...
      <section style={{
              ...
              {[
                ...
                <a
                  ...
                  style={{
                    ...
                    fontSize: '15px',
                    fontWeight: 600,
                    color: item.id === 'step2' ? '#fff' : '#2e2e2e',
                    backgroundColor: item.id === 'step2' ? '#16a085' : 'transparent',
                    border: 'none',
                    borderRadius: '8px',
                    textAlign: 'left',
                    textDecoration: 'none',
        ...
        <div style={{ flex: '1 1 800px' }}>
          <div style={{
            ...
            {coverLetterPosts.map((post, index) => (
              <div
                key={index}
                style={{
          ...
          {/* Cross-sell to Cover Letter Resources */}
          <div style={{
            marginTop: '48px',
            backgroundColor: '#fff',
            borderRadius: '12px',
            ...
            <p style={{
              ...
              Get started with our free cover letter template, or work with our experts for a professionally crafted cover letter that gets results.
            </p>
            <div style={{
              display: 'flex',
              gap: '16px',
